...
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <form action="posts/compartilhar.php" method="POST" enctype='multipart/form-data'>
                    <div class="input-group">
                        ...
                        <textarea name="conteudo" type="text" class="form-control" placeholder="Conte-nos novidades..." aria-label="Conte-nos novidades..." aria-describedby="basic-addon1" style="height: 70px;"></textarea>
                    </div>

                    <div class="form-check float-left">
                        <input name="destaque" type="checkbox" class="form-check-input" id="Destaque">
                        <label class="form-check-label" for="Destaque">Destaque</label>
                    </div>

                    <div class="btn-group float-right" role="group" >
                        <input name="imagem" type="file" class="btn btn-secondary">
